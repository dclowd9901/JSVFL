  ...
  constraintWalker: function (lastType, constraints) {
    ...
    if (lastType === undefined) {
      ...
      if (result = this.orientationTokens.exec(this.vfl)) {
        ...
        return this.constraintWalker(this.TYPES.ORIENTATION, constraints);
      // |
      ...
      switch (lastType) {
        ...
        if (result = this.viewTokens.exec(this.vfl)) {
          ...
          if (result[0] === '[') {
            constraints.lastConstraint().instruction = Constraint.INSTRUCTIONS.SPACING;
            constraints.lastConstraint().value = 0;
        ...
        if (result = this.connectionTokens.exec(this.vfl)) {
          ...
          constraints.lastConstraint().instruction = Constraint.INSTRUCTIONS.SPACING;
          constraints.lastConstraint().value = Constraint.DEFAULT_SPACING
        ...
        if (result = this.numberTokens.exec(this.vfl)) {
          ...
          constraints.lastConstraint().value = result[0];
